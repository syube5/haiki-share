...
<div class="container">
    <div class="p-form">
        <div class="p-form__body">
            ...
            <form method="POST" action="{{ route('conveniencestore.login') }}" class="u-p9">
                @csrf
                ...
                <div>
                    アカウントをお持ちでない方は<a href="{{ route('conveniencestore.register') }}">こちら</a>
                </div>
                <div class="u-mt1">
                    パスワードをお忘れの方は<a href="{{ route('conveniencestore.password.request') }}">こちら</a>
                </div>
            </form>
        </div>
    </div>
